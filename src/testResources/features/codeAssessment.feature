...
#    Then User searches through the results for word "Table" in the title and adds the last one to the cart
#    Then User navigates to the cart and validates item is in the cart
